...
if __name__ == "__main__":
    ...
    parser.add_argument('--steps_per_epoch', type=int, default=10000, help='steps_per_epoch')
    ...
    train_set = TrajectoryLmdbDataset({"src": os.path.join(data_root, 'train_dataset')})
    ...
    if os.path.exists(os.path.join(data_root, 'data_stat.pkl')):
