...
if __name__ == '__main__':
    ...
    for val_mode in ['val_ood_ads', 'val_ood_cat', 'val_ood_both', 'val_id']:
        ...
        valid_loader = DataLoader(valid_set, batch_size=128, shuffle=False, collate_fn=partial(collate_fn, otf_graph=False), num_workers=4)
        ...
        df.to_csv(f'LEIGNN_{data_type}_{val_mode}.csv', index=False)
